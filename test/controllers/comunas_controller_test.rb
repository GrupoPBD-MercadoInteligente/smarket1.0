...
class ComunasControllerTest < ActionController::TestCase
  ...
  test "should create comuna" do
    assert_difference('Comuna.count') do
      post :create, comuna: { comuna_id: @comuna.comuna_id, comuna_nombre: @comuna.comuna_nombre, provincia_id: @comuna.provincia_id }
    end
  ...
  test "should update comuna" do
    patch :update, id: @comuna, comuna: { comuna_id: @comuna.comuna_id, comuna_nombre: @comuna.comuna_nombre, provincia_id: @comuna.provincia_id }
    assert_redirected_to comuna_path(assigns(:comuna))
  end
